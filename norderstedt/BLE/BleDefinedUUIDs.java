package com.example.frfr01.norderstedt.BLE;

/**
 * Created by Friederike Fröbel on 21.05.2018.
 */
...
public class BleDefinedUUIDs {
    ...
    public static class Service {
        ...
        final static public UUID NORDIC_UART = UUID.fromString("6e400001-b5a3-f393-e0a9-e50e24dcca9e");
    }
    ...
    public static class Characteristic {
        ...
        final static public UUID NORDIC_UART_TX = UUID.fromString("6e400002-b5a3-f393-e0a9-e50e24dcca9e");
        final static public UUID NORDIC_UART_RX = UUID.fromString("6e400003-b5a3-f393-e0a9-e50e24dcca9e");
